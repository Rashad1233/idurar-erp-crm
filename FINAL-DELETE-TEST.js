...
function runFinalDeleteTest() {
  ...
  console.log('=============================');
  console.log('- Press Ctrl+Shift+D to open the debugger panel');
  console.log('- Click the "Debug" button in the top-right corner');
...
if (typeof window !== 'undefined') {
  window.runFinalDeleteTest = runFinalDeleteTest;
}
