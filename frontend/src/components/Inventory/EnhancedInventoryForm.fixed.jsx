...
export default function EnhancedInventoryForm({ isUpdateForm = false, current = {} }) {
  ...
  // Define fetchUnspscDescription BEFORE any useEffects that depend on it
  ...
  // NOW we can safely use fetchUnspscDescription in other useEffects
  useEffect(() => {
  ...
  }, [itemMasterSearchText, itemMasters]);  
