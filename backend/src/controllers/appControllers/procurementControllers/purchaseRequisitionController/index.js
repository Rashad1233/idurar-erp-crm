...
// GET /purchase-requisition/read/:id to get purchase requisition by id (for frontend compatibility)
router.get('/read/:id', readController.readPurchaseRequisitions);
