// Script to reset ALL procurement tables to fix UUID foreign key issues
...
async function resetAllProcurementTables() {
  try {
    console.log('🔄 Connecting to database...');
    await client.connect();
    console.log('✅ Database connection established');

    // Drop ALL procurement tables that have foreign key constraints to Users table
    const tablesToDrop = [
      'ApprovalHistories',
    ...
    console.log('🗑️ Dropping ALL procurement tables to fix data type conflicts...');
