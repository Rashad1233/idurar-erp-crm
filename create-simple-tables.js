...
async function createTables() {
  try {
    ...
    // Create Sales Orders table (without foreign key constraints)
    ...
    // Create Sales Order Items table (without foreign key constraints)
    ...
    console.log('🏗️ Creating Items table...');
    ...
    console.log('🏗️ Creating Sales Orders table...');
    await SalesOrders.sync({ force: false });
    console.log('✅ Sales Orders table created');
    
    console.log('🏗️ Creating Sales Order Items table...');
    ...
    console.log('✅ Customers data added');
